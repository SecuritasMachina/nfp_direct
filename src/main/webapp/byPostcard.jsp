...
<%
    ...
    List<Postcard> myPage = postcardService.getPage(pageNbr);
%>
    ...
    <div class="card-body">
        ...
        <h5 class="card-title">
            <div class="alert alert-primary" role="alert">
                <%=WordUtils.capitalizeFully(postcard.getCompany_name())%> <%=postcard.getYear()%>
            </div>
        </h5>
        ...
        <a class="btn btn-outline-primary" href="details.jsp?id=<%=postcard.getId()%>">Details
            for <%=postcard.getCompany_name()%>
            DBA <%=postcard.getDBA1()%>
        </a>
...
<ul class="nav justify-content-center">
    ...
    <li class="nav-item">
        <a class="btn btn-outline-primary" href="index.jsp?page=<%=pageNbr-1%>">Previous Page(<%=pageNbr
                -
                1%>)</a>
    </li>
    <%}%>
    <li class="nav-item">
        <a class="btn btn-outline-primary" href="index.jsp?page=<%=pageNbr+1%>">Next Page(<%=pageNbr
                +
                1%>)</a><br/>
    </li>
